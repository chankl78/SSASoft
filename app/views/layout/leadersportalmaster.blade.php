...
<html lang="en">
	...
	<body class="no-skin">
		@include('layout/leadersportalheader')
		<div class="main-container" id="main-container">
			...
			<div class="sidebar responsive" id="sidebar">
				...
				@include('layout/leadersportalsidebarshortcuts')
				@include('layout/leadersportalsidebarleft')
		...
		@include('layout/leadersportaljavascript')
