				...
				<div class="col-sm-offset-2 col-xs-12 col-sm-8 widget-container-col ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Group Type</h5>
						...
						<div class="widget-body">
							...
							<div class="widget-toolbox padding-8 clearfix">
								{{ Form::open(array('action' => 'GroupzGroupTypeController@postGroupType', 'id' => 'fResourceAdd', 'class' => 'form-horizontal')) }}
									<fieldset>
				...
				<div id="resourceedit" class="modal" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'GroupzGroupTypeController@putGroupType', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
								<fieldset>
