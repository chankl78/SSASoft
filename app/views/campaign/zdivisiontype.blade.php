...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{{ URL::action('GroupController@getIndex') }}}">Group</a></li>
			<li class="active">Division Type</li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Group<small><i class="ace-icon fa fa-angle-double-right"></i> Group Type</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-sm-offset-2 col-xs-12 col-sm-8 widget-container-col ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Division Type</h5>
						...
						<div class="widget-body">
							...
							<div class="widget-toolbox padding-8 clearfix">
								{{ Form::open(array('action' => 'GroupzDivisionTypeController@postDivisionType', 'id' => 'fResourceAdd', 'class' => 'form-horizontal')) }}
									<fieldset>
				...
				<div id="resourceedit" class="modal" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'GroupzDivisionTypeController@putDivisionType', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
								<fieldset>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$('#resourceupdate').submit(function(e){
				...
				$.ajax({
			        url: 'putDivisionType/' + $("#evalueid").val(),
			        type: 'POST',
			        data: { evalue: $("#evalue").val(), evalueid: $("#evalueid").val() },
			        dataType: 'json',
			        statusCode: { 
			        	200:function(){
			        		var oTable = $('#tdefault').DataTable();
