...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{{ URL::action('AttendanceController@getIndex') }}}">Attendance</a></li>
			<li class="active">{{ $pagetitle }}</li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Attendance Detail<small><i class="ace-icon fa fa-angle-double-right"></i> {{ $pagetitle }}</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
					...
					<div class="tab-content">
						<div id="home" class="tab-pane in active">
							@foreach ($result as $result)
									...
									<div class="widget-box widget-color-orange collapsed">
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												{{ Form::open(array('action' => 'AttendanceDetailController@putAttendance', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
													<br />
													...
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::select('groupattendance', $groups_options, $result->groupname, array('class' => 'col-xs-12 col-sm-9', 'id' => 'groupattendance'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													...
													<div hidden>
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																...
																<div class="clearfix">
																	{{ Form::text('groupid', $result->groupid, array('class' => 'col-xs-12 col-sm-9', 'id' => 'eventid'));}}
																</div>
																<div class="clearfix">
								...
								</div><!-- Attendance Detail Information -->
								<div class="col-xs-12 col-sm-6 widget-container-span ui-sortable">
									<div class="widget-box widget-color-purple collapsed">
										<div class="widget-header widget-header-small">
											<h6 class="widget-title">
												<i class="icon-sort"></i>
												Discussion Meeting Total Attendance Information
											</h6>
											<div class="widget-toolbar">
												<a href="#" data-action="fullscreen" class="orange2">
													<i class="ace-icon fa fa-expand"></i>
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												{{ Form::open(array('action' => 'AttendanceDetailController@putAttendance', 'id' => 'resourceupdate1', 'class' => 'form-horizontal')) }}
													<br />
													<div class="form-group">
														{{ Form::label('tokangmembership', 'Tokang Total:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('tokangmembership', $result->tokangmembership, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('md', $result->md, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('wd', $result->wd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('ymd', $result->ymd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('ywd', $result->ywd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('pd', 'Primary Division:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('pd', $result->pd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('yc', 'Young Children:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('yc', $result->yc, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('attendancetotal', 'Attendance Total:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('attendancetotal', $result->attendancetotal, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														<div class="col-md-offset-5 col-xs-12 col-sm-12">
															<div class="clearfix">
																{{ Form::button('<i class="fa fa-check fa fa-on-right"></i> Update', array('type' => 'Search', 'class' => 'btn btn-info btn-lg' )); }}
															</div>
														</div>
													</div>
												{{ Form::close() }}
								...
								</div><!-- Discussion Meeting Total Information -->
								<div class="col-xs-12 col-sm-6 widget-container-span ui-sortable">
									<div class="widget-box widget-color-purple collapsed">
										<div class="widget-header widget-header-small">
											<h6 class="widget-title">
												<i class="icon-sort"></i>
												Discussion Meeting By Division Total Attendance Information
											</h6>
											<div class="widget-toolbar">
												<a href="#" data-action="fullscreen" class="orange2">
													<i class="ace-icon fa fa-expand"></i>
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												{{ Form::open(array('action' => 'AttendanceDetailController@putAttendance', 'id' => 'resourceupdate2', 'class' => 'form-horizontal')) }}
													<br />
													<div class="form-group">
														{{ Form::label('ldr', 'Leaders:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('ldr', $result->ldr, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('mem', 'Members:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('mem', $result->mem, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('bel', 'Belivers:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('bel', $result->bel, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('nf', 'New Friend:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('nf', $result->nf, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
								...
								</div><!-- Discussion Meeting By Position Total Information -->
								<div class="col-xs-12 col-sm-6 widget-container-span ui-sortable">
									<div class="widget-box widget-color-purple collapsed">
										<div class="widget-header widget-header-small">
											<h6 class="widget-title">
												<i class="icon-sort"></i>
												Discussion Meeting Senior Leader Total Information
											</h6>
											<div class="widget-toolbar">
												<a href="#" data-action="fullscreen" class="orange2">
													<i class="ace-icon fa fa-expand"></i>
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												{{ Form::open(array('action' => 'AttendanceDetailController@putAttendancesr', 'id' => 'resourceupdatesr', 'class' => 'form-horizontal')) }}
													<br />
													<div class="form-group">
														{{ Form::label('srmd', 'MD:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('srmd', $result->srmd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('srwd', 'WD:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('srwd', $result->srwd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('srymd', 'YMD:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('srymd', $result->srymd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														{{ Form::label('srywd', 'YWD:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('srywd', $result->srywd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
								...
								</div><!-- Discussion Meeting Senior Leader Information -->
								<div class="col-xs-12 col-sm-6 widget-container-span ui-sortable">
									<div class="widget-box widget-color-purple collapsed">
										<div class="widget-header widget-header-small">
											<h6 class="widget-title">
												<i class="icon-sort"></i>
												Discussion Meeting Homevisit Total Information
											</h6>
											<div class="widget-toolbar">
												<a href="#" data-action="fullscreen" class="orange2">
													<i class="ace-icon fa fa-expand"></i>
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												{{ Form::open(array('action' => 'AttendanceDetailController@putAttendancehv', 'id' => 'resourceupdatehv', 'class' => 'form-horizontal')) }}
													<br />
													...
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('hvmd', $result->hvmd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('hvwd', $result->hvwd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('hvymd', $result->hvymd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														...
														<div class="col-xs-12 col-sm-9">
															<div class="clearfix">
																{{ Form::text('hvywd', $result->hvywd, array('class' => 'col-xs-12 col-sm-9'));}}
															</div>
														</div>
													</div>
													<div class="space-2"></div>
								...
								</div><!-- Discussion Meeting Homvevisit Information -->
							@endforeach
							<div class="col-xs-12 col-sm-6 widget-container-span ui-sortable">
								<div class="widget-box collapsed widget-color-green">
									...
									<div class="widget-body">
										<div class="widget-main no-padding">
											{{ Form::open(array('action' => 'AttendanceDetailController@postNricSearch', 'id' => 'resourcenricesearch', 'class' => 'form-horizontal')) }}
												<br />
												<div class="form-group">
							...
							<div class="col-xs-12 col-sm-6 widget-container-span ui-sortable">
								<div class="widget-box collapsed widget-color-green">
									...
									<div class="widget-body">
										<div class="widget-main no-padding">
											{{ Form::open(array('action' => 'AttendanceDetailController@postNricSearchExpress', 'id' => 'resourcenricesearchexpress', 'class' => 'form-horizontal')) }}
												<br />
												<div class="form-group">
							...
							<div class="col-xs-12 col-sm-6 widget-container-span ui-sortable">
								<div class="widget-box collapsed widget-color-red">
									<div class="widget-header widget-header-small">
										<h6 class="widget-title">
											<i class="icon-sort"></i>
											Mass Insert Attended Attendee into Event
										</h6>
										<div class="widget-toolbar">
											<a href="#" data-action="fullscreen" class="orange2">
												<i class="ace-icon fa fa-expand"></i>
									...
									<div class="widget-body">
										<div class="widget-main no-padding">
											{{ Form::open(array('action' => 'AttendanceDetailController@postMassForwardtoEvent', 'id' => 'resourcemassinserttoevent', 'class' => 'form-horizontal')) }}
												<br />
												<div class="form-group">
												...
												<div class="space-2"></div>
												<div class="form-group">
													{{ Form::label('eventroleforward', 'Role:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
													<div class="col-xs-12 col-sm-9">
														<div class="clearfix">
															{{ Form::select('eventroleforward', $role_options, 'Participant', array('class' => 'col-xs-12 col-sm-12', 'id' => 'eventroleforward'));}}
														</div>
													</div>
												</div>
												<div class="space-2"></div>
												<div class="form-group">
													<div class="col-md-offset-3 col-xs-12 col-sm-12">
														<div class="clearfix">
															{{ Form::button('<i class="fa fa-search fa fa-on-right"></i> Insert', array('type' => 'Insert', 'class' => 'btn btn-danger btn-lg' )); }}
														</div>
													</div>
												</div>
											{{ Form::close() }}
							...
							</div> <!-- Insert Attended Attendee to Event -->
							<div class="col-xs-12 col-sm-6 widget-container-span ui-sortable">
								<div class="widget-box collapsed widget-color-red">
									<div class="widget-header widget-header-small">
										<h6 class="widget-title">
											<i class="icon-sort"></i>
											Mass Insert DM Attendance By District 
										</h6>
										<div class="widget-toolbar">
											<a href="#" data-action="fullscreen" class="orange2">
												<i class="ace-icon fa fa-expand"></i>
									...
									<div class="widget-body">
										<div class="widget-main no-padding">
											{{ Form::open(array('action' => 'AttendanceDetailController@postDMMassInsertByDistrict', 'id' => 'resourceDMMassInsertByDistrict', 'class' => 'form-horizontal')) }}
												<br />
												<div class="form-group">
													<div class="col-md-offset-3 col-xs-12 col-sm-12">
														<div class="clearfix">
								...
								<div class="widget-box widget-color-blue">
									...
									<div class="widget-body">
											...
											<table id="tdefault" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="hidden-480">No of NF</th>
										...
										<div class="widget-toolbox padding-8 clearfix">
											@if ($REAT04D == 't')
												{{ Form::open(array('action' => 'AttendanceDetailController@deleteAllAttendee', 'id' => 'fDeleteAllAttendee', 'class' => 'form-horizontal')) }}
														<fieldset>
							...
							<div id="btneventmemadd" class="modal" tabindex="-1">
								<div class="modal-dialog">
									<div class="modal-content">
										{{ Form::open(array('action' => 'AttendanceDetailController@postAddMember', 'id' => 'resourceaddmember', 'class' => 'form-horizontal')) }}
											<fieldset>
							...
							<div id="btneventnewfriendadd" class="modal" tabindex="-1">
								<div class="modal-dialog">
									<div class="modal-content">
										{{ Form::open(array('action' => 'AttendanceDetailController@postAddNewFriend', 'id' => 'resourceaddnewfriend', 'class' => 'form-horizontal')) }}
											<fieldset>
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												...
												<div class="modal-body overflow-visible">
													<div class="row">
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-8">
																<div class="clearfix">
																	{{ Form::select('nfposition', $memposition_options, '', array('class' => 'col-xs-12 col-sm-11', 'id' => 'nfposition'));}}
																</div>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-8">
																<div class="clearfix">
																	{{ Form::select('nfdivision', $division_options, $result->division, array('class' => 'col-xs-12 col-sm-11', 'id' => 'nfdivision'));}}
																</div>
															</div>
														</div>
														<div class="form-group">
							...
							<div id="resourceedit" class="modal" tabindex="-1">
								<div class="modal-dialog">
									<div class="modal-content">
										{{ Form::open(array('action' => 'AttendanceDetailController@putEditMember', 'id' => 'memberupdate', 'class' => 'form-horizontal')) }}
											<fieldset>
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal">&times;</button>
										...
										<div class="widget-main">
											<table id="trhqstats" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														<th class="hidden-480">RHQ</th>
														<th class="hidden-480">MD</th>
														<th class="hidden-480">WD</th>
														<th class="hidden-480">YM</th>
														<th class="hidden-480">YW</th>
														<th class="hidden-480">PD</th>
														<th class="hidden-480">Unknown</th>
														<th class="hidden-480">Total</th>
														<th class="hidden-480">New Friend</th>
													</tr>
												</thead>
												<tbody>
												</tbody>
...
@section('js')
	...
	<script type="text/javascript">
		$(document).ready(function () {
		    ...
		    $('#resourceupdate1').submit(function(e){
		    	$.ajax({
			        url: 'putAttendance1/' + $("#moduleid").val(),
			        type: 'POST',
			        data: {  },
			        dataType: 'json',
			        statusCode: { 
			        	200:function(data){
	            			$("#tokangmembership").val(data.tokangmembership);
			        		$("#md").val(data.md);
			        		$("#wd").val(data.wd);
			        		$("#ymd").val(data.ymd);
			        		$("#ywd").val(data.ywd);
			        		$("#attendancetotal").val(data.attendancetotal);
			        		$("#ldr").val(data.ldr);
			        		$("#mem").val(data.mem);
			        		$("#bel").val(data.bel);
			        		$("#nf").val(data.nf);
		    ...
		    $('#resourceupdate2').submit(function(e){
		    	$.ajax({
			        url: 'putAttendance2/' + $("#moduleid").val(),
			        type: 'POST',
			        data: {  },
			        dataType: 'json',
			        statusCode: { 
		    ...
		    $('#resourceupdatesr').submit(function(e){
		    	noty({
					layout: 'topRight', type: 'warning', text: 'Updating Record ...',
					animation: { open: 'animated tada', close: 'animated hinge', easing: 'swing', speed: 500 },
					timeout: 4000
				...
				$.ajax({
			        url: 'putAttendancesr/' + $("#moduleid").val(),
			        type: 'POST',
			        data: { srmd: $("#srmd").val(), srwd: $("#srwd").val(), srymd: $("#srymd").val(), srywd: $("#srywd").val()},
			        dataType: 'json',
			        statusCode: { 
			        	200:function(data){
			        		$("#tokangmembership").val(data.tokangmembership);
		    ...
		    $('#resourceupdatehv').submit(function(e){
		    	noty({
					layout: 'topRight', type: 'warning', text: 'Updating Record ...',
					animation: { open: 'animated tada', close: 'animated hinge', easing: 'swing', speed: 500 },
					timeout: 4000
				...
				$.ajax({
			        url: 'putAttendancehv/' + $("#moduleid").val(),
			        type: 'POST',
			        data: { hvmd: $("#hvmd").val(), hvwd: $("#hvwd").val(), hvymd: $("#hvymd").val(), hvywd: $("#hvywd").val() },
			        dataType: 'json',
			        statusCode: { 
			        	200:function(){
	            			noty({
		    ...
		    $('#resourcemassinserttoevent').submit(function(e){
		    	if ($('#eventforward').val() != "")
		    	{
		    		noty({
			    	...
			    	$.ajax({
				        url: 'postMassForwardtoEvent/"{{ $rid }}"',
				        type: 'POST',
				        data: { eventforward: $("#eventforward").val(), eventroleforward: $("#eventroleforward").val(), moduleid: "{{ $rid }}" },
				        dataType: 'json',
				        statusCode: { 
				        	200:function(data){
				        		noty({
			...
			$('#resourceDMMassInsertByDistrict').submit(function(e){
		    	noty({
					layout: 'topRight', type: 'warning', text: 'Inserting members to Discussion Meeting ',
					animation: { open: 'animated tada', close: 'animated hinge', easing: 'swing', speed: 500 },
					timeout: 500
				});
				$.ajax({
					url: 'postDMMassInsertByDistrict/"{{ $rid }}"',
					type: 'POST',
					data: { moduleid: "{{ $rid }}" },
					dataType: 'json',
					statusCode: { 
