...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{{ URL::action('VehicleListingController@getIndex') }}}">Vechicle Booking Status Listing</a></li>
			<li class="active">Vechicle Booking Status Listing</li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Vehicle Booking Status<small><i class="ace-icon fa fa-angle-double-right"></i> Listing</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-sm-offset-2 col-xs-12 col-sm-8 widget-container-col ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Vechicle Booking Status Listing</h5>
						...
						<div class="widget-body">
							...
							<div class="widget-toolbox padding-8 clearfix">
								{{ Form::open(array('action' => 'VehicleBookingStatusController@postStatus', 'id' => 'fResourceAdd', 'class' => 'form-horizontal')) }}
									<fieldset>
				...
				<div id="resourceedit" class="modal" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'VehicleBookingStatusController@putStatus', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
								<fieldset>
	        ...
	        noty({
				...
				buttons: [
				    {addClass: 'btn btn-primary', text: 'Ok', onClick: function($noty) {
				    	...
				    	$.ajax({
					        url: 'zBookingStatus/deleteStatus/' + submit,
					        type: 'POST',
		...
		$(document).ready(function () {
			$(function() {
				var oTable = $('#tdefault').DataTable({
			        ...
			        "searching": true,
			        "order": [[ 0, "desc" ]],
			        "ajax": 'zBookingStatus/getListing',
			        "aoColumnDefs": [
	            	{
			...
			$('#resourceupdate').submit(function(e){
				...
				$.ajax({
			        url: 'zBookingStatus/putStatus/' + $("#evalueid").val(),
			        type: 'POST',
