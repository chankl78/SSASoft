...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{{ URL::action('VehicleListingController@getIndex') }}}">Vechicle Booking Listing</a></li>
			<li class="active">Vechicle Booking Listing</li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Vehicle<small><i class="ace-icon fa fa-angle-double-right"></i> Booking Listing</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-xs-12 col-sm-12 widget-container-col ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Vehicle Booking Listing</h5>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'VehicleBookingListingController@postModule', 'id' => 'resourceadd', 'class' => 'form-horizontal')) }}
								<fieldset>
									...
									<div class="modal-body overflow-visible">
										<div class="row">
											<div class="form-group">
												{{ Form::label('moduledate', 'Booking Date:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
												<div class="col-xs-12 col-sm-8">
													<div class="clearfix">
														{{ Form::text('moduledate', '', array('class' => 'col-xs-11 col-sm-11 input-mask-date', 'id' => 'moduledate', 'placeholder' => 'DD-MM-YYYY'));}}
													</div>
												</div>
											</div>
											<div class="form-group">
												{{ Form::label('modulestarttime', 'Start Time:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
												<div class="col-xs-12 col-sm-8">
													<div class="clearfix">
														{{ Form::text('modulestarttime', '', array('class' => 'col-xs-11 col-sm-11', 'id' => 'modulestarttime', 'placeholder' => 'HH:mm'));}}
													</div>
												</div>
											</div>
											<div class="form-group">
												{{ Form::label('moduleendtime', 'End Time:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
												<div class="col-xs-12 col-sm-8">
													<div class="clearfix">
														{{ Form::text('moduleendtime', '', array('class' => 'col-xs-11 col-sm-11', 'id' => 'moduleendtime', 'placeholder' => 'HH:mm'));}}
													</div>
												</div>
											</div>
											<div class="form-group">
												{{ Form::label('vehicleno', 'Vehicle:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
												<div class="col-xs-12 col-sm-9">
													<div class="clearfix">
														{{ Form::select('vehicleno', $vehicleno_options, array('class' => 'col-xs-12 col-sm-12', 'id' => 'vehicleno'));}}
													</div>
												</div>
											</div>
											<div class="form-group">
												{{ Form::label('description', 'Purpose:', array('class' => 'control-label col-xs-12 col-sm-3 no-padding-right')); }}
												<div class="col-xs-12 col-sm-8">
													<div class="clearfix">
									...
									<div class="modal-footer">
										...
										{{ Form::button('<i class="fa fa-check"></i> <strong>Save</strong>', array('type' => 'Submit', 'class' => 'btn btn-sm btn-primary', 'id' => 'resourceadd')); }}
									</div>
								</fieldset>
							{{ Form::close() }}
						</div>
				...
				<div id="resourceedit" class="modal" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'VehicleBookingListingController@putModule', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
								<fieldset>
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
		...
		$(document).ready(function () {
			$(function() {
				var oTable = $('#tdefault').DataTable({
			        ...
			        "searching": true,
			        "order": [[ 0, "desc" ]],
			        "ajax": 'VehicleBookingListing/getListing',
			        "aoColumnDefs": [
	            	{
				    	"targets": [ 0 ], "data": "bookingdate", "width": "170px", "searchable": "true",
				    	"render": function ( data, type, full ){
				    		return moment(data).format("DD-MMM-YYYY HH:mm:ss");
					    }
			    	},
			    	{ "targets": [ 1 ], "data": "starttime", "searchable": "true" },
					{ "targets": [ 2 ], "data": "endtime", "searchable": "true" },
					{ "targets": [ 3 ], "data": "vehicleno", "searchable": "true" },
					{ "targets": [ 4 ], "data": "description", "searchable": "true" },
					{ "targets": [ 5 ], "data": "bookbyname", "searchable": "true" },
					{ "targets": [ 6 ], "data": "approvedby", "searchable": "true" },
					{ "targets": [ 7 ], "data": "overnightapprovedby", "searchable": "true" },
					{ "targets": [ 8 ], "data": "status", "searchable": "true" },
			    	{
			...
			$('#fResourceAdd').submit(function(e){
				...
				$.ajax({
			        url: 'VehicleBookingListing/postModule',
			        type: 'POST',
			        data: { moduledate: $("#moduledate").val(), starttime: $("#modulestarttime").val(), endtime: $("#moduleendtime").val(), vehicleno: $("#vehicleno").val(),description: $("#description").val()},
			        dataType: 'json',
			        statusCode: { 
			        	200:function(){
			        		var oTable = $('#tdefault').DataTable();
			        		oTable.ajax.reload(null, false);
			        		$("#moduledate").val(''); $("#modulestarttime").val(''); $("#moduleendtime").val(''); $("#description").val('');
	            			noty({
			        	...
			        	400:function(info){ 
			        		noty({
								layout: 'topRight', type: 'error', text: 'Failed to Create!!  Please check your entry.' + info,
								animation: { open: 'animated tada', close: 'animated hinge', easing: 'swing', speed: 500 
									},
								timeout: 4000
							}); 
			...
			$('#resourceupdate').submit(function(e){
				...
				$.ajax({
			        url: 'VehicleBookingListing/putModule/' + $("#evalueid").val(),
			        type: 'POST',
