				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						<li>
							...
							<a href="#">NDP 2021 Registration</a>
						</li>
												...
												<div class="widget-main col-xs-12 col-sm-12">
													...
													<div class="step-pane" id="step2">
														<div class="widget-box transparent">
															<div class="widget-body">
																<div class="widget-main no-padding">
																	<div class="col-md-offset-1 col-xs-12 col-sm-11 widget-container-span ui-sortable">
																		<div class="widget-box transparent">
																			<div class="widget-body">
																				<div class="widget-main no-padding">
																					<div align="justify">
																				...
																				<div class="widget-main no-padding">
																					{{ Form::open(array('id' => 'resourceHealth', 'class' => 'form-horizontal')) }}
																						...
																						<div class="form-group">
																							...
																							<div class="col-xs-12 col-sm-7">
																								<div class="clearfix">
																									{{ Form::textarea('drugallergy', '', array('class' => 'col-xs-12 col-sm-11', 'rows' => '2', 'id' => 'drugallergy'));}}
																								</div>
																							</div>
																						</div>
																					{{ Form::close() }}
																			...
																			<div class="widget-body">
																				<div class="widget-main no-padding">
																					{{ Form::open(array('id' => 'resourceVaccine', 'class' => 'form-horizontal')) }}
																						...
																						<div class="form-group">
																							{{ Form::label('vaccinetaken', 'Have you taken Vaccine?', array('class' => 'control-label col-xs-12 col-sm-8 no-padding-right')); }}
																							<div class="col-xs-12 col-sm-4">
																								<div class="clearfix">
																						...
																						<div class="form-group">
																							{{ Form::label('vaccineotherpast', 'Have you taken any other vaccinations in the past 2 weeks  (e.g. ALIVE, Pre-departure vaccinations)?', array('class' => 'control-label col-xs-12 col-sm-8 no-padding-right')); }}
																							<div class="col-xs-12 col-sm-4">
																								<div class="clearfix">
			...
			jQuery(function($) {
				...
				.on('change' , function(e, info){
					...
					if (info.step == 3)
					{
						...
						{
							$.ajax({
						        url: 'ndp2021registration/postAuthorizationCheck',
						        type: 'POST',
