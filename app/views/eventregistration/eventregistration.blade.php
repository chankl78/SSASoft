...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>SSASOFT - Event Registration</title>
							...
							<div class="col-xs-12 col-sm-7 widget-container-span ui-sortable">
								<div class="widget-box widget-color-blue">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">Event Registration Wizard</h4>
									</div>
											...
											<div id="fuelux-wizard" data-target="#step-container">
												...
												<ul class="wizard-steps">
													<li data-target="#step1" class="active">
														...
														<span class="title">Select Event</span>
													</li>
													...
													<li data-target="#step3">
														...
														<span class="title">Introducer</span>
													</li>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							...
							Singapore Soka Association &copy; 2013-2015
						</span>
					</div>
					<!-- /section:basics/footer -->
				</div>
