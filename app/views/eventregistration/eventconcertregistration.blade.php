							...
							<div class="col-xs-12 col-sm-12 widget-container-span ui-sortable">
								<div class="widget-box widget-color-blue">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">Concert Registration Wizard</h4>
									</div>
											...
											<div id="fuelux-wizard" data-target="#step-container">
												...
												<ul class="wizard-steps">
													...
													<li data-target="#step2">
														...
														<span class="title">Personal Infomation</span>
													</li>
													...
													<div class="widget-box transparent">
														<div class="widget-body">
															<div class="widget-main no-padding">
																<center><h1>Youth Concert Registration</h1></center>
															</div>
														</div>
													</div>
												</div>
																				...
																				{{ Form::open(array('action' => 'EventMemRegistrationController@postAddMember', 'id' => 'addnewfriend', 'class' => 'form-horizontal')) }}
																					<fieldset>
																						...
																						<div class="form-group" hidden>
																							...
																							<div class="col-xs-12 col-sm-9">
																								<div class="clearfix">
																									{{ Form::text('eventid', '591bd1f44444c0.23677704', array('class' => 'col-xs-12 col-sm-9', 'id' => 'eventid', 'readonly' => 'true'));}}
																								</div>
																							</div>
																						</div>
																						<div class="form-group" hidden>
