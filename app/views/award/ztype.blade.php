...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{{ URL::action('AwardController@getIndex') }}}">Award / Gift / Certificate</a></li>
			<li class="active">Type</li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Award / Gift / Certificate<small><i class="ace-icon fa fa-angle-double-right"></i> Type</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
					...
					<div class="widget-box widget-color-blue">
						...
						<div class="widget-body">
							...
							<div class="widget-toolbox padding-8 clearfix">
								{{ Form::open(array('action' => 'AwardzTypeController@postType', 'id' => 'fResourceAdd', 'class' => 'form-horizontal')) }}
									<fieldset>
				...
				<div id="resourceedit" class="modal" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'AwardzTypeController@putType', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
								<fieldset>
