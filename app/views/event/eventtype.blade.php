...
@section('content')
	...
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Event<small><i class="ace-icon fa fa-angle-double-right"></i> Event Type</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-sm-offset-2 col-xs-12 col-sm-8 widget-container-col ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Event Type</h5>
						...
						<div class="widget-body">
							...
							<div class="widget-toolbox padding-8 clearfix">
								{{ Form::open(array('action' => 'EventzEventTypeController@postEventType', 'id' => 'fResourceAdd', 'class' => 'form-horizontal')) }}
									<fieldset>
				...
				<div id="resourceedit" class="modal" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'EventzEventTypeController@putEventType', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
								<fieldset>
