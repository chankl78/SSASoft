...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active"><a href="{{{ URL::action('EventController@getIndex') }}}">Events</a></li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Event Listing</h5>
										...
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-7">
													<div class="clearfix">
														{{ Form::select('divisiontype', $divisiontype_options, '4 Division', array('class' => 'col-xs-12 col-sm-12', 'id' => 'divisiontype'));}}
													</div>
												</div>
											</div>
											<div class="form-group">
...
@section('js')
	...
	<script type="text/javascript">
		function editrow(submit){ 
			$.ajax({
		        url: 'Event/postEventACCheck/' + submit,
		        type: 'POST',
		        data: { value: submit },
		        dataType: 'json',
		        statusCode: { 
		        	200:function(){
				        ...
				        $("#tdefault tbody tr").click(function () {
			                ...
			                window.location.href = "Event/Detail/" + submit;
			            });
		        	},
		        	400:function(data){ 
		        		var txtMessage;
		...
		$(document).ready(function () {
			...
			$('#resourceadd').submit(function(e){
				...
				$.ajax({
			        url: 'Event/postEvent',
			        type: 'POST',
			        data: { eventdate: $("#eventdate").val(), description: $("#description").val(), location: $("#location").val(), eventtype: $("#eventtype").val(), divisiontype: $("#divisiontype").val()},
			        dataType: 'json',
			        statusCode: { 
			        	200:function(){
			        		var oTable = $('#tdefault').DataTable();
