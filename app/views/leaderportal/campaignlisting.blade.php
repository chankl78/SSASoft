...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active"><a href="{{{ URL::action('LeadersPortalCampaignListingController@getIndex') }}}">Campaigns</a></li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
				...
				<div class="col-xs-12 col-sm-12 widget-container-span ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Campaign Listing</h5>
	...
	<script type="text/javascript">
		function editrow(submit){ 
	        ...
	        $("#tdefault tbody tr").click(function () {
                ...
                window.location.href = "BOEPortalCampaign/" + submit;
            });
	    }
	</script>
	<script type="text/javascript">	
		$(document).ready(function () {
			...
			$(function() {
				var oTable = $('#tdefault').DataTable({
			        ...
			        "searching": true,
			        "order": [[ 0, "desc" ]],
			        "ajax": 'BOEPortalCampaignListing/getListing',
			        "columnDefs": [
	            	{
			    	...
			    	{ 
			    		"targets": [ 2 ], "data": "status", "searchable": "true",
			    		"render": function ( data, type, full ){
						    if (data === 'Void'){
