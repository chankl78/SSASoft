...
@section('content')
	...
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Pre M&D Eligible Listing <small><i class="ace-icon fa fa-angle-double-right"></i> Overview</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-xs-12 col-sm-12 widget-container-span ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Pre M&D Eligible Listing</h5>
		...
		$(document).ready(function () {
			$(function() {
				var oTable = $('#tdefault').DataTable({
			        ...
			        ajax: 'BOEPortalPreMADEligibleListing/getListing',
			        columnDefs: [
