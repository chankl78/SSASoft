...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active"><a href="{{{ URL::action('LeadersPortalEventPastListingController@getIndex') }}}">Past Event</a></li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Past Event Listing</h5>
	...
	<script type="text/javascript">
		function editrow(submit){ 
	        ...
	        $("#tdefault tbody tr").click(function () {
                ...
                window.location.href = "BOEPortalEventPast/" + submit;
            });
	    }
	</script>
	<script type="text/javascript">	
		$(document).ready(function () {
			...
			$(function() {
				var oTable = $('#tdefault').DataTable({
			        ...
			        deferRender: true,
			        order: [[ 0, "desc" ]],
			        ajax: 'BOEPortalEventPastListing/getListing',
			        columnDefs: [
	            	{
