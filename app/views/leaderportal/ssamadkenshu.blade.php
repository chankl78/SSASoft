...
@section('content')
	...
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>SSA Mentor and Disciple Training Course Listing <small><i class="ace-icon fa fa-angle-double-right"></i> Overview</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-xs-12 col-sm-12 widget-container-span ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">SSA Mentor and Disciple Training Course Listing</h5>
		...
		$(document).ready(function () {
			$(function() {
				var oTable = $('#tdefault').DataTable({
			        ...
			        ajax: 'BOEPortalSSAMADKenshuListing/getListing',
			        columnDefs: [
						...
						{ targets: [ 8 ], data: "trainingdate", searchable: true },
						{ targets: [ 9 ], data: "language", searchable: true }
				    ]
			    });
			});
		});
