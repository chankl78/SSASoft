...
@section('content')
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Access Types</li>
		</ul><!--.breadcrumb-->
	</div><!--#breadcrumbs-->
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Access Rights<small><i class="ace-icon fa fa-angle-double-right"></i> Access Types</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-sm-offset-2 col-sm-8 widget-container-span ui-sortable">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title">Access Types</h5>
						...
						<div class="widget-body">
							...
							<div class="widget-toolbox padding-8 clearfix">
								{{ Form::open(array('action' => 'AccessRightsController@postAccessType', 'id' => 'fResourceAdd', 'class' => 'form-horizontal')) }}
									<fieldset>
				...
				<div id="resourceedit" class="modal" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'AccessRightsController@putAccessType', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
								<fieldset>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$('#resourceupdate').submit(function(e){
				...
				$.ajax({
			        url: 'putAccessType/' + $('#evalueid').val(),
			        type: 'POST',
