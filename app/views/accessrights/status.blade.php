...
@section('content')
	...
	<div class="page-content" id="page-content">
		<div class="page-header">
			<h1>Access Rights<small><i class="ace-icon fa fa-angle-double-right"></i> Status</small></h1>
		</div><!--/.page-header-->
		<div class="row">
			<div class="col-xs-12">
					...
					<div class="widget-box widget-color-blue">
						...
						<div class="widget-body">
							...
							<div class="widget-toolbox padding-8 clearfix">
								{{ Form::open(array('action' => 'AccessRightsController@postRole', 'id' => 'fResourceAdd', 'class' => 'form-horizontal')) }}
									<fieldset>
				...
				<div id="resourceedit" class="modal" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							{{ Form::open(array('action' => 'AccessRightsController@putStatus', 'id' => 'resourceupdate', 'class' => 'form-horizontal')) }}
								<fieldset>
