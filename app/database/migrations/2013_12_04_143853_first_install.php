...
class FirstInstall extends Migration {
	...
	public function up()
	{
		...
		Schema::create('Access_m_AccessRights', function($table)
		{
			$table->increments('id');
		...
		Schema::create('Access_m_Users', function($table)
		{
			$table->increments('id');
			$table->string('uniquecode', 25);
			$table->binary('name');
			$table->string('username', 50) ->index();
			$table->unique('username'); // Make username index & unique at the same time.
		...
		Schema::create('Access_z_AccessTypes', function($table)
		{
			$table->increments('id');
		...
		Schema::create('Access_z_Roles', function($table)
		{
			$table->increments('id');
		...
		Schema::create('Access_z_Status', function($table)
		{
			$table->increments('id');
		...
		Schema::create('Configuration_m_ResourceGroup', function($table)
		{
			$table->increments('id');
			$table->string('prefix', 10) -> nullable();
			$table->string('postfix', 10) -> nullable();
		...
		Schema::create('Configuration_m_Resource', function($table)
		{
			$table->increments('id');
		...
		// Logs
		Schema::create('Logs_m_Logs', function($table)
		{
			$table->increments('id');
			$table->integer('userid');
			$table->string('logtype', 10);
			$table->integer('resourceid');
			$table->integer('resourcecode')-> nullable();
		...
		Schema::create('Logs_z_LogType', function($table)
		{
			$table->increments('id');
			$table->string('value', 20);
			$table->timestamps();
		...
		Schema::create('Logs_z_Status', function($table)
		{
			$table->increments('id');
			$table->string('value', 20);
			$table->timestamps();
