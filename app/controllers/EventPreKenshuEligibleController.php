<?php
class EventPreKenshuEligibleController extends BaseController
{
	public $restful = true;

	public function getIndex()
	{
		Session::put('current_page', 'event/prekenshueligible');
		...
		$view = View::make('event/eventprekenshueligible');
		$view->title = 'Pre Kenshu Eligible Listing';
	...
	public function getListing()
	{
		try
		{
			$default = MembersmSSA::MADEligibleMembership()->get(array('name', 'rhq', 'zone', 'chapter', 'district', 'position', 'division'))->toarray();
			return Response::json(array('data' => $default));
		}
		catch(\Exception $e)
		{
			LogsfLogs::postLogs('Read', 60, 0, ' - Pre Kenshu Eligible [DT] - ' . $e, NULL, NULL, 'Failed');
		}
	}
