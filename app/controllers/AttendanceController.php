...
class AttendanceController extends BaseController
{
	...
	public function postDMStatsUpdate()
	{
		try
		{
			$statement = 'UPDATE Attendance_m_Attendance aa, (SELECT aa.id, aa.uniquecode, aa.description, COUNT(ap.attendancestatus) as TokangMembership, 
				SUM(CASE WHEN ap.division IN ("MD") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + srmd as "MD", 
				SUM(CASE WHEN ap.division IN ("WD") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + srwd as "WD", 
				SUM(CASE WHEN ap.division IN ("YM") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + srymd as "YMD", 
				SUM(CASE WHEN ap.division IN ("YW") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + srymd as "YWD", 
				SUM(CASE WHEN ap.division IN ("PD") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "PD", 
				SUM(CASE WHEN ap.division IN ("YC") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "YC", 
				SUM(CASE WHEN ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + (srmd + srwd + srymd + srywd) as "DivisionAttendanceTotal", 
				SUM(CASE WHEN ap.position NOT IN ("NF", "MEM", "BEL") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "LDR", 
				SUM(CASE WHEN ap.position IN ("MEM") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "MEM", 
				SUM(CASE WHEN ap.position IN ("BEL") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "BEL", 
				SUM(CASE WHEN ap.position IN ("NF") and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "NF", 
				SUM(CASE WHEN mp.level IN ("district", "group") and ap.division ="MD" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + aa.srmd as "ldrmd", 
				SUM(CASE WHEN mp.level IN ("mem") and ap.division = "MD" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "memmd", 
				SUM(CASE WHEN mp.level IN ("bel") and ap.division = "MD" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "belmd", 
				SUM(CASE WHEN mp.level IN ("nf") and ap.division = "MD" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "nfmd", 
				SUM(CASE WHEN mp.level IN ("district", "group") and ap.division = "WD" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + aa.srwd as "ldrwd", 
				SUM(CASE WHEN mp.level IN ("mem") and ap.division = "WD" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "memwd", 
				SUM(CASE WHEN mp.level IN ("bel") and ap.division = "WD" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "belwd", 
				SUM(CASE WHEN mp.level IN ("nf") and ap.division = "WD" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "nfwd", 
				SUM(CASE WHEN mp.level IN ("district", "group") and ap.division = "YM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + aa.srymd as "ldrymd", 
				SUM(CASE WHEN mp.level IN ("mem") and ap.division = "YM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "memymd", 
				SUM(CASE WHEN mp.level IN ("bel") and ap.division = "YM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "belymd", 
				SUM(CASE WHEN mp.level IN ("nf") and ap.division = "YM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "nfymd", 0 as PDm , 0 as YCm, 
				SUM(CASE WHEN mp.level IN ("district", "group") and ap.division = "YW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) + aa.srywd as "ldrywd", 
				SUM(CASE WHEN mp.level IN ("mem") and ap.division = "YW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "memywd", 
				SUM(CASE WHEN mp.level IN ("bel") and ap.division = "YW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "belywd", 
				SUM(CASE WHEN mp.level IN ("nf") and ap.division = "YW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "nfywd", 
				SUM(CASE WHEN mp.level IN ("mem") and ap.division = "PDYM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "mempdymd", 
				SUM(CASE WHEN mp.level IN ("bel") and ap.division = "PDYM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "belpdymd", 
				SUM(CASE WHEN mp.level IN ("nf") and ap.division = "PDYM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "nfpdymd", 
				SUM(CASE WHEN mp.level IN ("mem") and ap.division = "PDYW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "mempdywd", 
				SUM(CASE WHEN mp.level IN ("bel") and ap.division = "PDYW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "belpdywd", 
				SUM(CASE WHEN mp.level IN ("nf") and ap.division = "PDYW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "nfpdywd", 
				SUM(CASE WHEN mp.level IN ("mem") and ap.division = "YCYM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "memycymd", 
				SUM(CASE WHEN mp.level IN ("bel") and ap.division = "YCYM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "belycymd", 
				SUM(CASE WHEN mp.level IN ("nf") and ap.division = "YCYM" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "nfycymd", 
				SUM(CASE WHEN mp.level IN ("mem") and ap.division = "YCYW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "memycywd", 
				SUM(CASE WHEN mp.level IN ("bel") and ap.division = "YCYW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "belycywd", 
				SUM(CASE WHEN mp.level IN ("nf") and ap.division = "YCYW" and ap.attendancestatus IN ("attended") and ap.deleted_at IS NULL THEN 1 ELSE 0 End) as "nfycywd"
				FROM Attendance_m_Attendance aa 
				LEFT JOIN Attendance_m_Person ap on aa.id = ap.attendanceid 
				LEFT JOIN Members_z_Position mp on mp.code = ap.position WHERE attendancetype IN ("Discussion Meeting") and aa.status = "Active" and year(aa.attendancedate) =' . Input::get('txtyear') . ' and month(aa.attendancedate) = ' . Input::get('ddmonth') . ' and ap.deleted_at IS NULL GROUP BY aa.description) ap 
				SET aa.tokangmembership = ap.TokangMembership, aa.md = ap.md, aa.wd = ap.wd, aa.ymd = ap.ymd, aa.ywd = ap.ywd, aa.pd = ap.pd, aa.yc = ap.yc, aa.attendancetotal = ap.DivisionAttendanceTotal, aa.ldr = ap.LDR, aa.mem = ap.MEM, aa.bel = ap.BEL, aa.nf = ap.NF, aa.ldrmd = ap.ldrmd, aa.memmd = ap.memmd, aa.belmd = ap.belmd, aa.nfmd = ap.nfmd, aa.ldrwd = ap.ldrwd, aa.memwd = ap.memwd, aa.belwd = ap.belwd, aa.nfwd = ap.nfwd, aa.ldrymd = ap.ldrymd, aa.memymd = ap.memymd, aa.belymd = ap.belymd, aa.nfymd = ap.nfymd, aa.ldrywd = ap.ldrywd, aa.memywd = ap.memywd, aa.belywd = ap.belywd, aa.nfywd = ap.nfywd, aa.mempdymd = ap.mempdymd, aa.belpdymd = ap.belpdymd, aa.nfpdymd = ap.nfpdymd, aa.memycymd = ap.memycymd, aa.belycymd = ap.belycymd, aa.nfycymd = ap.nfycymd WHERE aa.id = ap.id;';
